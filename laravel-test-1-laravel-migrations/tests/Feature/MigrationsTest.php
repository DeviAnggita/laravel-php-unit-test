...
class MigrationsTest extends TestCase
{
    ...
    public function test_delete_parent_child_record(): void
    {
        // We just test if the test succeeds or throws an exception
        $this->expectNotToPerformAssertions();
    ...
    public function test_repeating_column_table(): void
    {
        // We just test if the migration succeeds or throws an exception
        $this->expectNotToPerformAssertions();
    ...
    public function test_automatic_value(): void
    {
    ...
    public function test_renamed_table(): void
    {
    ...
    public function test_renamed_column(): void
    {
    ...
    public function test_null_foreign_key(): void
    {
